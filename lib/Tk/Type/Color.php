 ...
 * @package Tk
 */
class Tk_Type_Color extends Tk_Object
{
     ...
     */
    static function createColor($hex)
    {
    ...
    function getInverse()
    {
        return self::createDecColor(255 - $this->getRed(), 255 - $this->getGreen(), 255 - $this->getBlue());
    }
