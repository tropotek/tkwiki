            ...
            setup: (editor) => {
                ...
                editor.ui.registry.addButton('wikiPage', {
                    ...
                    onAction: function (_) {
                        ...
                        htmx.ajax('GET', tkConfig.baseUrl + '/component/pageSelect', {
                            trigger: 'click queue:none',
                            target: 'body',
                            swap: 'beforeend',
                        });
                    }
                ...
                if (tkConfig.enableSecretMod) {
                    editor.ui.registry.addButton('wikiSecret', {
                        ...
                        onAction: function (_) {
                            ...
                            htmx.ajax('GET', tkConfig.baseUrl + '/component/secretSelect', {
                                trigger: 'click queue:none',
                                target: 'body',
                                swap: 'beforeend',
                            });
