 ...
 * @package Db
 */
class Tk_Db_Array extends Tk_Object implements Iterator, Countable, ArrayAccess
{
...
//    {
//        throw new Tk_Exception('Deprecated function');
//        $c = new self();
//        $c->objects = $array;
//        $c->total = count($array);
//        $c->idx = 0;
...
//    }
    ...
    function get($i)
    {
        ...
        if (isset($this->raw[$i])) {
            return $this->dataMap->loadObject($this->raw[$i]);
        }
    }
